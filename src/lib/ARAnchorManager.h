...
namespace ofxARKit {
    namespace core {
        ...
        public:
            ...
            void drawPlanes(ofxARKit::common::ARCameraMatrices cameraMatrices);
            ...
            void drawPlaneMeshes(ofxARKit::common::ARCameraMatrices cameraMatrices);
            ...
            void drawPlaneAt(ofxARKit::common::ARCameraMatrices cameraMatrices,int index=0);
